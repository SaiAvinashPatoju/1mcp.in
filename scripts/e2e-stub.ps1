...
$central = Join-Path $OutDir "mach1.exe"
$e2e     = Join-Path $OutDir "mach1e2e.exe"
...
$config = Join-Path $repoRoot "services\mach1\test\e2e\config.stub.json"
$smokes = Join-Path $repoRoot "services\mach1\test\e2e\smokes.stub.json"
